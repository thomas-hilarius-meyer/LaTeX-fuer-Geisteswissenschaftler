...
\lstdefinestyle{listinglfgw}{%
  ...
  morekeywords={%
  %b
  beginnumbering,biblerefformat,biblerefmap,biblerefstyle,bonuspointpoints,
  %c
  chapter,chbpword,chpword,chpgword,chqword,chsword,chtword,
  %e
  endnumbering,
  %f
  firstpageheadrule,
  ...
  %p
  pend,pibibleverse,pointpoints,printbibliography,printindex,pstart,
  %q
  question,
  %s
  solutiontitle,subsubsection
  },   
