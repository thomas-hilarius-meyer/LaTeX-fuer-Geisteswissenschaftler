...
\usepackage[german]{keystroke}% Ermöglicht die Darstellung von Computer-Tastatur Tasten in einer Text.
...
\providecommand*{\Package}[1]{\paket{#1}}%zwecks kompatibilität mit DTK
