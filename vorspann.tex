...
\lstdefinestyle{listinglfgw}{%
  ...
  %f
  firstlinenum,firstlinenumR,firstpageheadrule,footcite,footcites,footfullcite,fullcite,fillwithgrid,fillwithlines,fillwithdottedlines,
  %h
  ...
  only,onslide,
  %p
  Pages,parencite,pend,pibibleverse,pbibleverse,pointpoints,printbibheading,printbibliography,printindex,pstart,pgfimage,pgfusepath,
  pgfplothandlerlineto, pgfplotxyfile,
  %q
  quell,question,
  %r
  Rcolwidth,
  %s
  selectlanguage,setlength,setmsdatalabel,smartcite,smartcites,solutiontitle,subsubsection,setbeamerfont,setbeamercovered,
  %t
  textcite,textcites,thealteSeite,tableofcontents,
  %u
  usetheme,usecolortheme,usebackgroundtemplate,
  %v
  vari,
  %x
