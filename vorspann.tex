...
\lstdefinestyle{listinglfgw}{%
  ...
  bonuspointpoints,
  %c
  chbpword,chpword,chpgword,chqword,chsword,chtword,
  %f
  firstpageheadrule,
  %h
...
\usepackage[pagewise]{lineno} %%% MS: Kann man das nicht besser mit reledmac machen, da man es sowieso lädt?
...
<<<<<<< HEAD
\providerobustcmd*{\paket}[1]{\textsf{#1}\index[pakete]{#1}}
=======
\providecommand*{\paket}[2][]{\textsf{#2}\index[pakete]{\if$#1$#2\else#1\fi}}
>>>>>>> 7f89520da3c6eb3a65a9710be250646883b82d8f
