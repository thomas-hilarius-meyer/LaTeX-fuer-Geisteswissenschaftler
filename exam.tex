% !TeX root = lfgw.tex
\chapter{Prüfungen erstelken mit \paket{exam}}

exam\footcite{ziegenhagen:dtk2016/2}

\section{Einleitung}

CTAN hält eine Reihe von Paketen bereit, um Klausuren und Übungsblätter zu setzen, neben \paket{exam} sind hier \paket{eqexam}, \paket{exercise} und \paket{exsheets} zu nennen. 
