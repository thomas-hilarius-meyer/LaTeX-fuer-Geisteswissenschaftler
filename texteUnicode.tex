...
%MS: Man sollte hier seriös bleiben. ASCII = American Standard Code for Information Interchange
...
Für Windows 2000 bis Windows 7 gibt es den \Program{Microsoft Keyboard Layout Creator} kurz \Program{MSKLC}.
...
Die erste Möglichkeit besteht in der Eingabe mit Hilfe der Einzelbuchstaben-Symbole des Paketes
...
Dokument~-- mit Hilfe eines deutschen Computers mit QWERTZ-Tastatur~-- einzugeben.
