...
\documentclass[%
   ...
   DIV=13,%
   pagesize%
   ]{scrbook}  	% dieser DIV-Wert wird später überschrieben... (MS: alles integriert))
...
Der übliche Wortzwischenraum (Fachbezeichnung: Spatium (Sicher???)) wird von \LaTeX{} beim Absatzumbruch innerhalb einer Zeile
