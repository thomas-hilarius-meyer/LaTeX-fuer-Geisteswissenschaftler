...
\item[\Program{Vim}] (Windows + Linux + macOS) \url{http://www.vim.org} Eine
  ...
  Anfänger leicht überfordert.  Für den langjährigen Nutzer ist
...
\item[\Program{Emacs}] (Windows + Linux + macOS) 
  ...
  \Program{AucTeX} ist der Emacs der eine integrierte Entwicklungsumgebung
  ...
  Versionverwaltung integriert.  Für Anfänger ist der \Program{Emacs} nur
...
\item[\Program{TeXStudio}] (Win + Linux + macOS 2009)
  ...
  Tippfehler also schon bei der Eingabe.
