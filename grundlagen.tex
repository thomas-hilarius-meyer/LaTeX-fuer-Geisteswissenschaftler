...
Zum Glück gab es mit der \Program{TeXShell} eine Oberfläche, die die einzelnen Programme hinter
Knöpfen versteckte.
...
Das \Program{TexnicCenter} war die erste wirklich integrierte Entwicklungsumgebung.
So konnte man \LaTeX{} ohne \Program{command.com} benutzen.

\item[\Program{Texshop}] (macOS 2001) \url{http://pages.uoregon.edu/koch/texshop/about.html}  Kurz nach dem 
Erscheinen von macOS (née OS X) erschien mit \Program{TeXShop} eine IDE für den Mac.
...
\item[\Program{TeXworks}] (Win + Linux + macOS 2009) \url{https://www.tug.org/texworks/}  Da \Program{TeXShop}
nur auf dem Mac läuft, wurde versucht mit \Program{TeXworks} eine Version für alle gängigen
...
bietet \Program{TeXStudio} auch eine integrierte Versionsverwaltung mit \Program{SVN}.
