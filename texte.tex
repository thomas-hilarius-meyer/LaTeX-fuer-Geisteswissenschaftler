...
Das \enquote{Laden} eines Paketes erfolgt durch den Befehl \lstinline/\usepackage[Optionen]{<PAKETNAME>}/
...
\minisec{Spatiierung bei Abkürzungen und andere Sonderfälle}

Wortzwischenräume lassen hinsichtlich Breite und Verhalten beim Zeilenumbruch noch 
weitere Differenzierungen zu:
