...
\paket{biblatex} wurde %XXXJAHR  einfügen
...
Am Beispiel von \cite{voss:einfuehrung} sei der Aufbau eines Einrags in der Bibliographiedatei erklärt (\cref{{lis:voss:einfuehrung}}):
...
Standardmäßig unterscheidet das \Paket{biblatex} XX %Anzahl
