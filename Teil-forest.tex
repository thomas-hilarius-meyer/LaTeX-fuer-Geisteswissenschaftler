...
% Habe lange überlegt was Astenden sind. Axel
...
entfernt. Mit den Befehlen \lstinline|text{  }| und \lstinline|\enspace| kann man das abändern (s. \ref{forestexample:15}).
...
\begin{lfgwexample}{label={forestexample:15axel}}
Mary wants to know\\
iii)  [[\textsubscript{wh} in which house] John lived t]
\end{lfgwexample}
%% amsmath
